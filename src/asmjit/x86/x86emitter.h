...
struct X86EmitterExplicitT {
  ...
  ASMJIT_INLINE X86Gp gpz(uint32_t id) const noexcept {
    return X86Gp(static_cast<const X86Gp&>(THIS_C()->_nativeGpReg), id);
  }
  ...
  ASMJIT_INLINE X86Mem ptr_base(uint32_t baseId, int32_t off = 0, uint32_t size = 0) const noexcept {
    uint32_t flags = 0;
    return X86Mem(Init, THIS_C()->_nativeGpReg.getRegType(), baseId, 0, 0, off, size, flags);
  }
  ...
  ASMJIT_INLINE This& rep(const X86Gp& zcx) noexcept {
    THIS()->addOptions(X86Inst::kOptionOpExtra | X86Inst::kOptionRep);
    THIS()->_opExtra = zcx;
    return *THIS();
  }
  //! Use REPNZ prefix.
  ASMJIT_INLINE This& repnz(const X86Gp& zcx) noexcept {
    THIS()->addOptions(X86Inst::kOptionOpExtra | X86Inst::kOptionRepnz);
    THIS()->_opExtra = zcx;
    return *THIS();
  }
  ...
  ASMJIT_INLINE This& mod_mr() noexcept { THIS()->addOptions(X86Inst::kOptionModMR); return *THIS(); }
  ...
  INST_2x(cmps, Cmps, DS_ZSI, ES_ZDI)                                  // ANY       [EXPLICIT]
  ...
  INST_2x(movs, Movs, ES_ZDI, DS_ZSI)                                  // ANY       [EXPLICIT]
  ...
  INST_2x(scas, Scas, ZAX, ES_ZDI)                                     // ANY       [EXPLICIT]
  ...
  INST_2x(stos, Stos, ES_ZDI, ZAX)                                     // ANY       [EXPLICIT]
  ...
  INST_3x(maskmovq, Maskmovq, X86Mm, X86Mm, DS_ZDI)                    // SSE  [EXPLICIT]
  INST_3x(maskmovdqu, Maskmovdqu, X86Xmm, X86Xmm, DS_ZDI)              // SSE2 [EXPLICIT]
  ...
  INST_3x(vmaskmovdqu, Vmaskmovdqu, X86Xmm, X86Xmm, DS_ZDI)            // AVX1 [EXPLICIT]
...
struct X86EmitterImplicitT : public X86EmitterExplicitT<This> {
  ...
  //! Use REP/REPZ prefix.
  ASMJIT_INLINE This& rep() noexcept { THIS()->addOptions(X86Inst::kOptionRep); return *THIS(); }
  //! Use REPNZ prefix.
  ASMJIT_INLINE This& repnz() noexcept { THIS()->addOptions(X86Inst::kOptionRepnz); return *THIS(); }
  ...
  ASMJIT_INLINE Error cmpsb() { return THIS()->emit(X86Inst::kIdCmps, X86EmitterExplicitT<This>::ptr_zsi(0, 1), X86EmitterExplicitT<This>::ptr_zdi(0, 1)); }
  ASMJIT_INLINE Error cmpsd() { return THIS()->emit(X86Inst::kIdCmps, X86EmitterExplicitT<This>::ptr_zsi(0, 4), X86EmitterExplicitT<This>::ptr_zdi(0, 4)); }
  ASMJIT_INLINE Error cmpsq() { return THIS()->emit(X86Inst::kIdCmps, X86EmitterExplicitT<This>::ptr_zsi(0, 8), X86EmitterExplicitT<This>::ptr_zdi(0, 8)); }
  ASMJIT_INLINE Error cmpsw() { return THIS()->emit(X86Inst::kIdCmps, X86EmitterExplicitT<This>::ptr_zsi(0, 2), X86EmitterExplicitT<This>::ptr_zdi(0, 2)); }

  ASMJIT_INLINE Error lodsb() { return THIS()->emit(X86Inst::kIdLods, x86::al , X86EmitterExplicitT<This>::ptr_zdi(0, 1)); }
  ASMJIT_INLINE Error lodsd() { return THIS()->emit(X86Inst::kIdLods, x86::eax, X86EmitterExplicitT<This>::ptr_zdi(0, 4)); }
  ASMJIT_INLINE Error lodsq() { return THIS()->emit(X86Inst::kIdLods, x86::rax, X86EmitterExplicitT<This>::ptr_zdi(0, 8)); }
  ASMJIT_INLINE Error lodsw() { return THIS()->emit(X86Inst::kIdLods, x86::ax , X86EmitterExplicitT<This>::ptr_zdi(0, 2)); }

  ASMJIT_INLINE Error movsb() { return THIS()->emit(X86Inst::kIdMovs, X86EmitterExplicitT<This>::ptr_zdi(0, 1), X86EmitterExplicitT<This>::ptr_zsi(0, 1)); }
  ASMJIT_INLINE Error movsd() { return THIS()->emit(X86Inst::kIdMovs, X86EmitterExplicitT<This>::ptr_zdi(0, 4), X86EmitterExplicitT<This>::ptr_zsi(0, 4)); }
  ASMJIT_INLINE Error movsq() { return THIS()->emit(X86Inst::kIdMovs, X86EmitterExplicitT<This>::ptr_zdi(0, 8), X86EmitterExplicitT<This>::ptr_zsi(0, 8)); }
  ASMJIT_INLINE Error movsw() { return THIS()->emit(X86Inst::kIdMovs, X86EmitterExplicitT<This>::ptr_zdi(0, 2), X86EmitterExplicitT<This>::ptr_zsi(0, 2)); }

  ASMJIT_INLINE Error scasb() { return THIS()->emit(X86Inst::kIdScas, x86::al , X86EmitterExplicitT<This>::ptr_zdi(0, 1)); }
  ASMJIT_INLINE Error scasd() { return THIS()->emit(X86Inst::kIdScas, x86::eax, X86EmitterExplicitT<This>::ptr_zdi(0, 4)); }
  ASMJIT_INLINE Error scasq() { return THIS()->emit(X86Inst::kIdScas, x86::rax, X86EmitterExplicitT<This>::ptr_zdi(0, 8)); }
  ASMJIT_INLINE Error scasw() { return THIS()->emit(X86Inst::kIdScas, x86::ax , X86EmitterExplicitT<This>::ptr_zdi(0, 2)); }

  ASMJIT_INLINE Error stosb() { return THIS()->emit(X86Inst::kIdStos, X86EmitterExplicitT<This>::ptr_zdi(0, 1), x86::al ); }
  ASMJIT_INLINE Error stosd() { return THIS()->emit(X86Inst::kIdStos, X86EmitterExplicitT<This>::ptr_zdi(0, 4), x86::eax); }
  ASMJIT_INLINE Error stosq() { return THIS()->emit(X86Inst::kIdStos, X86EmitterExplicitT<This>::ptr_zdi(0, 8), x86::rax); }
  ASMJIT_INLINE Error stosw() { return THIS()->emit(X86Inst::kIdStos, X86EmitterExplicitT<This>::ptr_zdi(0, 2), x86::ax ); }
