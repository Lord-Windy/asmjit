...
enum ODATA_ {
  ...
  ODATA_9B0000  = X86Inst::kOpCode_PP_9B | X86Inst::kOpCode_MM_00, // FPU, special case.
  ...
  ODATA_N_0      = 0 << X86Inst::kOpCode_CDOff_Shift, // N << 0 (BYTE).
  ODATA_N_1      = 1 << X86Inst::kOpCode_CDOff_Shift, // N << 1 (WORD).
  ODATA_N_2      = 2 << X86Inst::kOpCode_CDOff_Shift, // N << 2 (DWORD).
  ODATA_N_3      = 3 << X86Inst::kOpCode_CDOff_Shift, // N << 3 (QWORD).
  ODATA_N_4      = 4 << X86Inst::kOpCode_CDOff_Shift, // N << 4 (OWORD).
  ODATA_N_5      = 5 << X86Inst::kOpCode_CDOff_Shift, // N << 5 (YWORD).
...
#define X(PREFIX, OPCODE, O, L, W, EvexW, N, TT) (O_ENCODE(1, ODATA_##PREFIX, 0x##OPCODE, ODATA_O_##O, ODATA_L_##L, ODATA_W_##W, ODATA_EvexW_##EvexW, ODATA_N_##N, ODATA_TT_##TT) | X86Inst::kOpCode_VSIB)

#define O_00_X(OP, O) (X86Inst::kOpCode_PP_00 | (0x##OP & 0xFFU) | ((0x##OP >> 8) << X86Inst::kOpCode_2B_Shift) | ODATA_O_##O)
#define O_9B_X(OP, O) (X86Inst::kOpCode_PP_9B | (0x##OP & 0xFFU) | ((0x##OP >> 8) << X86Inst::kOpCode_2B_Shift) | ODATA_O_##O)
...
const X86Inst _x86InstData[] = {
  ...
  //                   |                   |                        |#0:PP-MMM OP/O L|W|W|N|TT. |#1:PP-MMM OP/O L|W|W|N|TT. | Global Flags|A512(CPU_|V|TT.|kz|rnd|b)| EF:OSZAPCDX |Idx|Cnt|Dst|Src| Idx|Cnt|    |
  // <-----------------+-------------------+------------------------+------------------+--------+------------------+--------+-------------+-------------------------+-------------+---+---+---+---+----+---+----+
// ${X86InstData:Begin}
  ...
  INST(F2xm1           , "f2xm1"           , Enc(FpuOp)             , O_00_X(D9F0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fabs            , "fabs"            , Enc(FpuOp)             , O_00_X(D9E1,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fadd            , "fadd"            , Enc(FpuArith)          , O_00_X(C0C0,0)            , 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 149, 3 , 68 ),
  INST(Faddp           , "faddp"           , Enc(FpuRDef)           , O_00_X(DEC0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Fbld            , "fbld"            , Enc(X86M_Only)         , O(000000,DF,4,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 371, 1 , 70 ),
  INST(Fbstp           , "fbstp"           , Enc(X86M_Only)         , O(000000,DF,6,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 371, 1 , 70 ),
  INST(Fchs            , "fchs"            , Enc(FpuOp)             , O_00_X(D9E0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fclex           , "fclex"           , Enc(FpuOp)             , O_9B_X(DBE2,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fcmovb          , "fcmovb"          , Enc(FpuR)              , O_00_X(DAC0,_)            , 0                         , F(Fp)                                 , EF(_____R__), 0 , 0 , 0 , 0 , 260, 1 , 71 ),
  INST(Fcmovbe         , "fcmovbe"         , Enc(FpuR)              , O_00_X(DAD0,_)            , 0                         , F(Fp)                                 , EF(__R__R__), 0 , 0 , 0 , 0 , 260, 1 , 72 ),
  INST(Fcmove          , "fcmove"          , Enc(FpuR)              , O_00_X(DAC8,_)            , 0                         , F(Fp)                                 , EF(__R_____), 0 , 0 , 0 , 0 , 260, 1 , 73 ),
  INST(Fcmovnb         , "fcmovnb"         , Enc(FpuR)              , O_00_X(DBC0,_)            , 0                         , F(Fp)                                 , EF(_____R__), 0 , 0 , 0 , 0 , 260, 1 , 71 ),
  INST(Fcmovnbe        , "fcmovnbe"        , Enc(FpuR)              , O_00_X(DBD0,_)            , 0                         , F(Fp)                                 , EF(__R__R__), 0 , 0 , 0 , 0 , 260, 1 , 72 ),
  INST(Fcmovne         , "fcmovne"         , Enc(FpuR)              , O_00_X(DBC8,_)            , 0                         , F(Fp)                                 , EF(__R_____), 0 , 0 , 0 , 0 , 260, 1 , 73 ),
  INST(Fcmovnu         , "fcmovnu"         , Enc(FpuR)              , O_00_X(DBD8,_)            , 0                         , F(Fp)                                 , EF(____R___), 0 , 0 , 0 , 0 , 260, 1 , 74 ),
  INST(Fcmovu          , "fcmovu"          , Enc(FpuR)              , O_00_X(DAD8,_)            , 0                         , F(Fp)                                 , EF(____R___), 0 , 0 , 0 , 0 , 260, 1 , 74 ),
  INST(Fcom            , "fcom"            , Enc(FpuCom)            , O_00_X(D0D0,2)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 261, 2 , 75 ),
  INST(Fcomi           , "fcomi"           , Enc(FpuR)              , O_00_X(DBF0,_)            , 0                         , F(Fp)                                 , EF(WWWWWW__), 0 , 0 , 0 , 0 , 260, 1 , 76 ),
  INST(Fcomip          , "fcomip"          , Enc(FpuR)              , O_00_X(DFF0,_)            , 0                         , F(Fp)                                 , EF(WWWWWW__), 0 , 0 , 0 , 0 , 260, 1 , 76 ),
  INST(Fcomp           , "fcomp"           , Enc(FpuCom)            , O_00_X(D8D8,3)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 261, 2 , 75 ),
  INST(Fcompp          , "fcompp"          , Enc(FpuOp)             , O_00_X(DED9,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fcos            , "fcos"            , Enc(FpuOp)             , O_00_X(D9FF,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fdecstp         , "fdecstp"         , Enc(FpuOp)             , O_00_X(D9F6,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fdiv            , "fdiv"            , Enc(FpuArith)          , O_00_X(F0F8,6)            , 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 149, 3 , 68 ),
  INST(Fdivp           , "fdivp"           , Enc(FpuRDef)           , O_00_X(DEF8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Fdivr           , "fdivr"           , Enc(FpuArith)          , O_00_X(F8F0,7)            , 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 149, 3 , 68 ),
  INST(Fdivrp          , "fdivrp"          , Enc(FpuRDef)           , O_00_X(DEF0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Femms           , "femms"           , Enc(X86Op)             , O(000F00,0E,_,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 77 ),
  INST(Ffree           , "ffree"           , Enc(FpuR)              , O_00_X(DDC0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 260, 1 , 78 ),
  INST(Fiadd           , "fiadd"           , Enc(FpuM)              , O(000000,DA,0,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Ficom           , "ficom"           , Enc(FpuM)              , O(000000,DA,2,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Ficomp          , "ficomp"          , Enc(FpuM)              , O(000000,DA,3,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fidiv           , "fidiv"           , Enc(FpuM)              , O(000000,DA,6,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fidivr          , "fidivr"          , Enc(FpuM)              , O(000000,DA,7,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fild            , "fild"            , Enc(FpuM)              , O(000000,DB,0,_,_,_,_,_  ), O(000000,DF,5,_,_,_,_,_  ), F(Fp)|F(Mem2_4_8)                     , EF(________), 0 , 0 , 0 , 0 , 373, 1 , 80 ),
  INST(Fimul           , "fimul"           , Enc(FpuM)              , O(000000,DA,1,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fincstp         , "fincstp"         , Enc(FpuOp)             , O_00_X(D9F7,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Finit           , "finit"           , Enc(FpuOp)             , O_9B_X(DBE3,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fist            , "fist"            , Enc(FpuM)              , O(000000,DB,2,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fistp           , "fistp"           , Enc(FpuM)              , O(000000,DB,3,_,_,_,_,_  ), O(000000,DF,7,_,_,_,_,_  ), F(Fp)|F(Mem2_4_8)                     , EF(________), 0 , 0 , 0 , 0 , 373, 1 , 81 ),
  INST(Fisttp          , "fisttp"          , Enc(FpuM)              , O(000000,DB,1,_,_,_,_,_  ), O(000000,DD,1,_,_,_,_,_  ), F(Fp)|F(Mem2_4_8)                     , EF(________), 0 , 0 , 0 , 0 , 373, 1 , 82 ),
  INST(Fisub           , "fisub"           , Enc(FpuM)              , O(000000,DA,4,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fisubr          , "fisubr"          , Enc(FpuM)              , O(000000,DA,5,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem2_4)                       , EF(________), 0 , 0 , 0 , 0 , 372, 1 , 79 ),
  INST(Fld             , "fld"             , Enc(FpuFldFst)         , O(000000,D9,0,_,_,_,_,_  ), O(000000,DB,5,_,_,_,_,_  ), F(Fp)|F(Mem4_8_10)                    , EF(________), 0 , 0 , 0 , 0 , 374, 1 , 83 ),
  INST(Fld1            , "fld1"            , Enc(FpuOp)             , O_00_X(D9E8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fldcw           , "fldcw"           , Enc(X86M_Only)         , O(000000,D9,5,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 375, 1 , 70 ),
  INST(Fldenv          , "fldenv"          , Enc(X86M_Only)         , O(000000,D9,4,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 376, 1 , 70 ),
  INST(Fldl2e          , "fldl2e"          , Enc(FpuOp)             , O_00_X(D9EA,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fldl2t          , "fldl2t"          , Enc(FpuOp)             , O_00_X(D9E9,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fldlg2          , "fldlg2"          , Enc(FpuOp)             , O_00_X(D9EC,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fldln2          , "fldln2"          , Enc(FpuOp)             , O_00_X(D9ED,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fldpi           , "fldpi"           , Enc(FpuOp)             , O_00_X(D9EB,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fldz            , "fldz"            , Enc(FpuOp)             , O_00_X(D9EE,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fmul            , "fmul"            , Enc(FpuArith)          , O_00_X(C8C8,1)            , 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 149, 3 , 68 ),
  INST(Fmulp           , "fmulp"           , Enc(FpuRDef)           , O_00_X(DEC8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Fnclex          , "fnclex"          , Enc(FpuOp)             , O_00_X(DBE2,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fninit          , "fninit"          , Enc(FpuOp)             , O_00_X(DBE3,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fnop            , "fnop"            , Enc(FpuOp)             , O_00_X(D9D0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fnsave          , "fnsave"          , Enc(X86M_Only)         , O(000000,DD,6,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 376, 1 , 70 ),
  INST(Fnstcw          , "fnstcw"          , Enc(X86M_Only)         , O(000000,D9,7,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 375, 1 , 70 ),
  INST(Fnstenv         , "fnstenv"         , Enc(X86M_Only)         , O(000000,D9,6,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 376, 1 , 70 ),
  INST(Fnstsw          , "fnstsw"          , Enc(FpuStsw)           , O(000000,DD,7,_,_,_,_,_  ), O_00_X(DFE0,_)            , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 377, 1 , 84 ),
  INST(Fpatan          , "fpatan"          , Enc(FpuOp)             , O_00_X(D9F3,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fprem           , "fprem"           , Enc(FpuOp)             , O_00_X(D9F8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fprem1          , "fprem1"          , Enc(FpuOp)             , O_00_X(D9F5,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fptan           , "fptan"           , Enc(FpuOp)             , O_00_X(D9F2,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Frndint         , "frndint"         , Enc(FpuOp)             , O_00_X(D9FC,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Frstor          , "frstor"          , Enc(X86M_Only)         , O(000000,DD,4,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 376, 1 , 70 ),
  INST(Fsave           , "fsave"           , Enc(X86M_Only)         , O(9B0000,DD,6,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 376, 1 , 70 ),
  INST(Fscale          , "fscale"          , Enc(FpuOp)             , O_00_X(D9FD,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fsin            , "fsin"            , Enc(FpuOp)             , O_00_X(D9FE,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fsincos         , "fsincos"         , Enc(FpuOp)             , O_00_X(D9FB,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fsqrt           , "fsqrt"           , Enc(FpuOp)             , O_00_X(D9FA,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fst             , "fst"             , Enc(FpuFldFst)         , O(000000,D9,2,_,_,_,_,_  ), 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 262, 1 , 85 ),
  INST(Fstcw           , "fstcw"           , Enc(X86M_Only)         , O(9B0000,D9,7,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 375, 1 , 70 ),
  INST(Fstenv          , "fstenv"          , Enc(X86M_Only)         , O(9B0000,D9,6,_,_,_,_,_  ), 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 376, 1 , 70 ),
  INST(Fstp            , "fstp"            , Enc(FpuFldFst)         , O(000000,D9,3,_,_,_,_,_  ), O(000000,DB,7,_,_,_,_,_  ), F(Fp)|F(Mem4_8_10)                    , EF(________), 0 , 0 , 0 , 0 , 374, 1 , 86 ),
  INST(Fstsw           , "fstsw"           , Enc(FpuStsw)           , O(9B0000,DD,7,_,_,_,_,_  ), O_9B_X(DFE0,_)            , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 377, 1 , 87 ),
  INST(Fsub            , "fsub"            , Enc(FpuArith)          , O_00_X(E0E8,4)            , 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 149, 3 , 68 ),
  INST(Fsubp           , "fsubp"           , Enc(FpuRDef)           , O_00_X(DEE8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Fsubr           , "fsubr"           , Enc(FpuArith)          , O_00_X(E8E0,5)            , 0                         , F(Fp)|F(Mem4_8)                       , EF(________), 0 , 0 , 0 , 0 , 149, 3 , 68 ),
  INST(Fsubrp          , "fsubrp"          , Enc(FpuRDef)           , O_00_X(DEE0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Ftst            , "ftst"            , Enc(FpuOp)             , O_00_X(D9E4,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fucom           , "fucom"           , Enc(FpuRDef)           , O_00_X(DDE0,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Fucomi          , "fucomi"          , Enc(FpuR)              , O_00_X(DBE8,_)            , 0                         , F(Fp)                                 , EF(WWWWWW__), 0 , 0 , 0 , 0 , 260, 1 , 76 ),
  INST(Fucomip         , "fucomip"         , Enc(FpuR)              , O_00_X(DFE8,_)            , 0                         , F(Fp)                                 , EF(WWWWWW__), 0 , 0 , 0 , 0 , 260, 1 , 76 ),
  INST(Fucomp          , "fucomp"          , Enc(FpuRDef)           , O_00_X(DDE8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 69 ),
  INST(Fucompp         , "fucompp"         , Enc(FpuOp)             , O_00_X(DAE9,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fwait           , "fwait"           , Enc(X86Op)             , O(000000,DB,_,_,_,_,_,_  ), 0                         , F(Fp)|F(Volatile)                     , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 88 ),
  INST(Fxam            , "fxam"            , Enc(FpuOp)             , O_00_X(D9E5,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fxch            , "fxch"            , Enc(FpuR)              , O_00_X(D9C8,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 2 , 78 ),
  ...
  INST(Fxtract         , "fxtract"         , Enc(FpuOp)             , O_00_X(D9F4,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fyl2x           , "fyl2x"           , Enc(FpuOp)             , O_00_X(D9F1,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  INST(Fyl2xp1         , "fyl2xp1"         , Enc(FpuOp)             , O_00_X(D9F9,_)            , 0                         , F(Fp)                                 , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 67 ),
  ...
  INST(Vgatherdpd      , "vgatherdpd"      , Enc(VexRmvRm_VM)       , X(660F38,92,_,x,1,_,_,_  ), X(660F38,92,_,x,_,1,3,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 92 , 5 , 376),
  INST(Vgatherdps      , "vgatherdps"      , Enc(VexRmvRm_VM)       , X(660F38,92,_,x,0,_,_,_  ), X(660F38,92,_,x,_,0,2,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 97 , 5 , 377),
  INST(Vgatherpf0dpd   , "vgatherpf0dpd"   , Enc(VexM_VM)           , X(660F38,C6,1,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 439, 1 , 378),
  INST(Vgatherpf0dps   , "vgatherpf0dps"   , Enc(VexM_VM)           , X(660F38,C6,1,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 440, 1 , 379),
  INST(Vgatherpf0qpd   , "vgatherpf0qpd"   , Enc(VexM_VM)           , X(660F38,C7,1,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 441, 1 , 378),
  INST(Vgatherpf0qps   , "vgatherpf0qps"   , Enc(VexM_VM)           , X(660F38,C7,1,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 441, 1 , 379),
  INST(Vgatherpf1dpd   , "vgatherpf1dpd"   , Enc(VexM_VM)           , X(660F38,C6,2,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 439, 1 , 378),
  INST(Vgatherpf1dps   , "vgatherpf1dps"   , Enc(VexM_VM)           , X(660F38,C6,2,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 440, 1 , 379),
  INST(Vgatherpf1qpd   , "vgatherpf1qpd"   , Enc(VexM_VM)           , X(660F38,C7,2,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 441, 1 , 378),
  INST(Vgatherpf1qps   , "vgatherpf1qps"   , Enc(VexM_VM)           , X(660F38,C7,2,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 441, 1 , 379),
  INST(Vgatherqpd      , "vgatherqpd"      , Enc(VexRmvRm_VM)       , X(660F38,93,_,x,1,_,_,_  ), X(660F38,93,_,x,_,1,3,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 102, 5 , 380),
  INST(Vgatherqps      , "vgatherqps"      , Enc(VexRmvRm_VM)       , X(660F38,93,_,x,0,_,_,_  ), X(660F38,93,_,x,_,0,2,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 123, 4 , 381),
  ...
  INST(Vpgatherdd      , "vpgatherdd"      , Enc(VexRmvRm_VM)       , X(660F38,90,_,x,0,_,_,_  ), X(660F38,90,_,x,_,0,2,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 97 , 5 , 477),
  INST(Vpgatherdq      , "vpgatherdq"      , Enc(VexRmvRm_VM)       , X(660F38,90,_,x,1,_,_,_  ), X(660F38,90,_,x,_,1,3,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 92 , 5 , 478),
  INST(Vpgatherqd      , "vpgatherqd"      , Enc(VexRmvRm_VM)       , X(660F38,91,_,x,0,_,_,_  ), X(660F38,91,_,x,_,0,2,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 123, 4 , 479),
  INST(Vpgatherqq      , "vpgatherqq"      , Enc(VexRmvRm_VM)       , X(660F38,91,_,x,1,_,_,_  ), X(660F38,91,_,x,_,1,3,T1S), F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 102, 5 , 480),
  ...
  INST(Vpscatterdd     , "vpscatterdd"     , Enc(VexMr_VM)          , X(660F38,A0,_,x,_,0,2,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 236, 3 , 529),
  INST(Vpscatterdq     , "vpscatterdq"     , Enc(VexMr_VM)          , X(660F38,A0,_,x,_,1,3,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 236, 3 , 530),
  INST(Vpscatterqd     , "vpscatterqd"     , Enc(VexMr_VM)          , X(660F38,A1,_,x,_,0,2,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 337, 2 , 529),
  INST(Vpscatterqq     , "vpscatterqq"     , Enc(VexMr_VM)          , X(660F38,A1,_,x,_,1,3,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 239, 3 , 530),
  ...
  INST(Vscatterdpd     , "vscatterdpd"     , Enc(VexMr_Lx)          , X(660F38,A2,_,x,_,1,3,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 343, 2 , 577),
  INST(Vscatterdps     , "vscatterdps"     , Enc(VexMr_Lx)          , X(660F38,A2,_,x,_,0,2,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 236, 3 , 578),
  INST(Vscatterpf0dpd  , "vscatterpf0dpd"  , Enc(VexM_VM)           , X(660F38,C6,5,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 439, 1 , 378),
  INST(Vscatterpf0dps  , "vscatterpf0dps"  , Enc(VexM_VM)           , X(660F38,C6,5,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 440, 1 , 379),
  INST(Vscatterpf0qpd  , "vscatterpf0qpd"  , Enc(VexM_VM)           , X(660F38,C7,5,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 441, 1 , 378),
  INST(Vscatterpf0qps  , "vscatterpf0qps"  , Enc(VexM_VM)           , X(660F38,C7,5,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 441, 1 , 379),
  INST(Vscatterpf1dpd  , "vscatterpf1dpd"  , Enc(VexM_VM)           , X(660F38,C6,6,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 439, 1 , 378),
  INST(Vscatterpf1dps  , "vscatterpf1dps"  , Enc(VexM_VM)           , X(660F38,C6,6,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 440, 1 , 379),
  INST(Vscatterpf1qpd  , "vscatterpf1qpd"  , Enc(VexM_VM)           , X(660F38,C7,6,2,_,1,3,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 8 , 441, 1 , 378),
  INST(Vscatterpf1qps  , "vscatterpf1qps"  , Enc(VexM_VM)           , X(660F38,C7,6,2,_,0,2,T1S), 0                         , F(RO)       |A512(PF  ,0,K_,0  ,B)    , EF(________), 0 , 0 , 0 , 4 , 441, 1 , 379),
  INST(Vscatterqpd     , "vscatterqpd"     , Enc(VexMr_Lx)          , X(660F38,A3,_,x,_,1,3,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 8 , 8 , 239, 3 , 577),
  INST(Vscatterqps     , "vscatterqps"     , Enc(VexMr_Lx)          , X(660F38,A3,_,x,_,0,2,T1S), 0                         , F(WO)       |A512(F_  ,1,K_,0  ,B)    , EF(________), 0 , 0 , 4 , 4 , 337, 2 , 578),
  ...
  INST(Vstmxcsr        , "vstmxcsr"        , Enc(VexM)              , V(000F00,AE,3,0,I,_,_,_  ), 0                         , F(Volatile)|F(Vex)                    , EF(________), 0 , 0 , 0 , 0 , 420, 1 , 582),
  ...
  INST(Vzeroall        , "vzeroall"        , Enc(VexOp)             , V(000F00,77,_,1,I,_,_,_  ), 0                         , F(Volatile)|F(Vex)                    , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 585),
  INST(Vzeroupper      , "vzeroupper"      , Enc(VexOp)             , V(000F00,77,_,0,I,_,_,_  ), 0                         , F(Volatile)|F(Vex)                    , EF(________), 0 , 0 , 0 , 0 , 259, 1 , 585),
...
const X86Inst::ExtendedData _x86InstExtendedData[] = {
  ...
  { Enc(FpuArith)           , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem4_8)                       , 0                          },
  ...
  { Enc(FpuM)               , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem2_4)                       , 0                          },
  { Enc(FpuM)               , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem2_4_8)                     , O(000000,DF,5,_,_,_,_,_  ) },
  { Enc(FpuM)               , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem2_4_8)                     , O(000000,DF,7,_,_,_,_,_  ) },
  { Enc(FpuM)               , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem2_4_8)                     , O(000000,DD,1,_,_,_,_,_  ) },
  { Enc(FpuFldFst)          , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem4_8_10)                    , O(000000,DB,5,_,_,_,_,_  ) },
  { Enc(FpuStsw)            , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)                                 , O_00_X(DFE0,_)             },
  { Enc(FpuFldFst)          , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem4_8)                       , 0                          },
  { Enc(FpuFldFst)          , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)|F(Mem4_8_10)                    , O(000000,DB,7,_,_,_,_,_  ) },
  { Enc(FpuStsw)            , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Fp)                                 , O_9B_X(DFE0,_)             },
  ...
  { Enc(VexRmvRm_VM)        , 0  , 0  , 8  , 8  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,92,_,x,_,1,3,T1S) },
  { Enc(VexRmvRm_VM)        , 0  , 0  , 4  , 4  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,92,_,x,_,0,2,T1S) },
  { Enc(VexM_VM)            , 0  , 0  , 0  , 8  , 0x00, 0x00, 0, F(RO)       |A512(PF  ,0,K_,0  ,B)    , 0                          },
  { Enc(VexM_VM)            , 0  , 0  , 0  , 4  , 0x00, 0x00, 0, F(RO)       |A512(PF  ,0,K_,0  ,B)    , 0                          },
  { Enc(VexRmvRm_VM)        , 0  , 0  , 8  , 8  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,93,_,x,_,1,3,T1S) },
  { Enc(VexRmvRm_VM)        , 0  , 0  , 4  , 4  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,93,_,x,_,0,2,T1S) },
  ...
  { Enc(VexRmvRm_VM)        , 0  , 0  , 4  , 4  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,90,_,x,_,0,2,T1S) },
  { Enc(VexRmvRm_VM)        , 0  , 0  , 8  , 8  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,90,_,x,_,1,3,T1S) },
  { Enc(VexRmvRm_VM)        , 0  , 0  , 4  , 4  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,91,_,x,_,0,2,T1S) },
  { Enc(VexRmvRm_VM)        , 0  , 0  , 8  , 8  , 0x00, 0x00, 0, F(RW)|F(Vex)|A512(F_  ,1,K_,0  ,B)    , X(660F38,91,_,x,_,1,3,T1S) },
  ...
  { Enc(VexMr_VM)           , 0  , 0  , 4  , 4  , 0x00, 0x00, 0, F(WO)       |A512(F_  ,1,K_,0  ,B)    , 0                          },
  { Enc(VexMr_VM)           , 0  , 0  , 8  , 8  , 0x00, 0x00, 0, F(WO)       |A512(F_  ,1,K_,0  ,B)    , 0                          },
  ...
  { Enc(VexMr_Lx)           , 0  , 0  , 8  , 8  , 0x00, 0x00, 0, F(WO)       |A512(F_  ,1,K_,0  ,B)    , 0                          },
  { Enc(VexMr_Lx)           , 0  , 0  , 4  , 4  , 0x00, 0x00, 0, F(WO)       |A512(F_  ,1,K_,0  ,B)    , 0                          },
  ...
  { Enc(VexM)               , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Volatile)|F(Vex)                    , 0                          },
  { Enc(VexRm_Lx)           , 0  , 0  , 8  , 8  , 0x00, 0x3F, 0, F(RO)|F(Vex)                          , 0                          },
  { Enc(VexRm_Lx)           , 0  , 0  , 4  , 4  , 0x00, 0x3F, 0, F(RO)|F(Vex)                          , 0                          },
  { Enc(VexOp)              , 0  , 0  , 0  , 0  , 0x00, 0x00, 0, F(Volatile)|F(Vex)                    , 0                          },
...
Error X86Inst::validate(
  ...
  else if (archId == ArchInfo::kIdX64) {
...
static Error x86_validate(uint32_t id, const Operand& o0 = Operand(), const Operand& o1 = Operand(), const Operand& o2 = Operand()) {
  ...
  return X86Inst::validate(ArchInfo::kIdX86, id, 0, Operand(), opArray, 3);
}

static Error x64_validate(uint32_t id, const Operand& o0 = Operand(), const Operand& o1 = Operand(), const Operand& o2 = Operand()) {
  Operand opArray[] = { o0, o1, o2 };
  return X86Inst::validate(ArchInfo::kIdX64, id, 0, Operand(), opArray, 3);
}
